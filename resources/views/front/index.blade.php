            ...
            <div class="row">
                ...
                <div class="col-lg-8 offset-lg-1">
                    <div class="filter-control">
                        <ul>
                            <li class="item active" data-tag="*" data-category="women">Alls</li>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-8">
                    <div class="filter-control">
                        <ul>
                            <li class="item active" data-tag="*" data-category="men">Alls</li>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="single-benefit">
                            ...
                            <div class="sb-text">
                                <h6>Secury payment</h6>
                                <p>100% secury payment</p>
                            </div>
                        </div>
                    </div>
                </div>
