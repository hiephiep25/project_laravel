                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-pic-zoom">
                            <img class="product-big-img" src="storage/{{$product->productImages[0]->path}}" alt="">
                            <div class="zoom-icon">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                ...
                                <div class="pt active" data-imgbigurl="stograge/{{$productImage->path}}">
                            ...
                            <div class="specification-table">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="cart-add">Add to cart</div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td><div class="p-weight">{{$product->weight}} kg</div></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @foreach(array_unique(array_column($product->productDetails->toArray(),'color')) as $productcolor)
                                            <div class="p-code">{{$productcolor}}</div>
                                            @endforeach
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="p-cateogry">Sku</td>
